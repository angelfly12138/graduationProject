package com.zhf.job.service.impl;

import com.zhf.common.annotation.CronTag;
import com.zhf.common.service.impl.BaseService;
import com.zhf.job.dao.JobMapper;
import com.zhf.job.domain.Job;
import com.zhf.job.service.JobService;
import com.zhf.job.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("com.zhf.job.task");
